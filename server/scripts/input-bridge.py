...
if platform == 'ds':
    ...
    # Two disjoint sets so controller 1 and 2 can be held at the same time;
    # these mirror DuckStation's Pad1/Pad2 bindings.
    allowed |= {0x49, 0x4A, 0x4B, 0x4C, 0x51, 0x45, 0x31, 0x33, 0x57, 0x44}
    allowed |= {0x54, 0x47, 0x46, 0x48, 0x4F, 0x55, 0x50, 0x4D,
                0x52, 0x5A, 0x34, 0x36, 0x35, 0x37, 0x59, 0x4E, 0x56, 0x42}
elif platform == 'psp':
    allowed |= {0x57, 0x51}
